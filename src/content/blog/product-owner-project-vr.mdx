...
We were guided to this by a lesson given by William Marié, a producer at Old Skull Games.
...
The first problem we encountered when it comes to the organization on Project VR was that the artists were frustrated by the structure and they didn't understand why they weren't proposed management roles.
...
Another issue we had was that we were told that this year, the artists would not be like externs on the project, but they would be more involved.
...
This led to me resigning from my role as a PO on the project, especially when it comes to communicating with the artists.
